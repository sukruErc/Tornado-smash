...
public class GameManager : MonoBehaviour
{
    ...
    {
        DOTween.To(() => TornadoController.instance.centerCollider.radius, x => TornadoController.instance.centerCollider.radius = x, 
            levelEndSweepCollRadius, levelEndSweepTime);
    } 
