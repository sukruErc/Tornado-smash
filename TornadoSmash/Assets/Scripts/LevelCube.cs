...
public class LevelCube : MonoBehaviour
{
    ...
    void HandleInVacuum()
    {
        transform.Rotate(new Vector3((risingRotationSpeed / 2f) * Time.deltaTime, 
            (risingRotationSpeed / 2f) * Time.deltaTime, (risingRotationSpeed / 2f) * Time.deltaTime), Space.Self);
    } 
